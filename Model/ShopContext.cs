...
namespace WepApi.Model
{
    ...
    {
        //Constructor til options ved dependency injection
        public ShopContext(DbContextOptions<ShopContext> options) : base(options)
        { }


        //Relatioen mellem modelClasses defineres her: 
        //En kategori har flere produkter
        ...
        //Hente og gemme produkter
        //Skal kunne tilgåes ved Context.prodcts
